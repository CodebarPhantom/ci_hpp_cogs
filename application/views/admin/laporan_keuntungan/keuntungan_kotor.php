	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="x_panel">
				...
				;?>
									<h2>
										<strong>Laporan Keuntungan Kotor <?php echo $bulan;?> <?php echo $tahun;?> </strong>
									</h2>         
									<div align="right">
										<strong><p align="right"><a type="button" class="btn btn-round btn-success" onclick="window.print()"><i class="fa fa-print">&nbsp </i>Print</a></p></strong> 
									</div>
